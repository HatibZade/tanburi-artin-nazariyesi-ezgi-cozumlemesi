# -*- coding: utf-8 -*-
"""Tanburi Küçük Artin (Musikî Edvârı) makam tahlil verisi (FULL v1.1).

Değişiklik:
- Segâh, Irâk ve Eviç/Evc perdeleri 'nim' etiketinden çıkarılıp 'tam' listesine taşındı.

Kullanım:
    from tanburi_kucuk_artin_makam_tahlil_full_v1_1 import DATA
"""
