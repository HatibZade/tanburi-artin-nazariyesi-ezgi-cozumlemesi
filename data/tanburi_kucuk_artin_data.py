DATA = {
  ...
  "ui_note": {
    "karar_merkez_baslangic": "Sadece tam perdeler (ASIL_CORE)",
    "alt_ust_sinir": "Tam + Nim (ALLOWED)",
    "asil_perdeler": "Tüm tam perdeler (ASIL_CORE)",
    "nim_perdeler": "Tüm nim perdeler (NIM_OPTIONS)"
  }
}