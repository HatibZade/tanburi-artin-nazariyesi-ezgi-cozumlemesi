# -*- coding: utf-8 -*-
"""Tanburi Küçük Artin veri seti (stable).
...
DATA = {
  ...
  "notes": [
    "Bu veri setinde 'kullanilan_perdeler' alanı ikiye ayrılır: asil_perdeler (kullanıcı tanımı) ve nim_perdeler (diğerleri).",
  ...
  "classification": {
    "rule": "asil_perdeler listesinde olanlar asil; digerleri nim",
    "asil_perdeler": [
      "yegah",
      "aşiran",
      "ırak",
